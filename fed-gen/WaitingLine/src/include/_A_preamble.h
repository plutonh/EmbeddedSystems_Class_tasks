...
void _lf_executable_preamble() {
    ...
    _fed.triggers_for_network_input_control_reactions_size = 5;
...
do { \
    ...
    _lf_action_table[3] = (lf_action_base_t*)&a_main_self[0]->_lf_networkMessage_4; \
    _lf_action_table[4] = (lf_action_base_t*)&a_main_self[0]->_lf_networkMessage_5; \
    ...
    /* Add trigger a_main_self[0]->_lf__inputControlReactionTrigger_4 to the global list of network input ports. */ \
    _fed.triggers_for_network_input_control_reactions[3]= \
        &a_main_self[0]->_lf__inputControlReactionTrigger_4; \
    /* Add trigger a_main_self[0]->_lf__inputControlReactionTrigger_5 to the global list of network input ports. */ \
    _fed.triggers_for_network_input_control_reactions[4]= \
        &a_main_self[0]->_lf__inputControlReactionTrigger_5; \
...
void send_neighbor_structure_to_RTI(int rti_socket) {
    ...
    size_t buffer_size = 1 + 8 + 
                    5 * ( sizeof(uint16_t) + sizeof(int64_t) ) +
                    2 * sizeof(uint16_t);
    ...
    message_head++;
    encode_int32((int32_t)5, &(buffer_to_send[message_head]));
