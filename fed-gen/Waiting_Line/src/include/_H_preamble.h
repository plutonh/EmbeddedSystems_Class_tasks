...
do { \
    _lf_action_table[0] = (lf_action_base_t*)&h_main_self[0]->_lf_networkMessage; \
    /* Add trigger h_main_self[0]->_lf__inputControlReactionTrigger to the global list of network input ports. */ \
    _fed.triggers_for_network_input_control_reactions[0]= \
        &h_main_self[0]->_lf__inputControlReactionTrigger; \
    _fed.trigger_for_network_output_control_reactions=&h_main_self[0]->_lf__outputControlReactionTrigger; \
} \
while (0)
/**
