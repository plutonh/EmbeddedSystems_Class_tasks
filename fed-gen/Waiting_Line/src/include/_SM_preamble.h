...
do { \
    _lf_action_table[0] = (lf_action_base_t*)&sm_main_self[0]->_lf_networkMessage_0; \
    /* Add trigger sm_main_self[0]->_lf__inputControlReactionTrigger_0 to the global list of network input ports. */ \
